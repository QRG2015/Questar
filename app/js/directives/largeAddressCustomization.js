...
four51.app.directive('largeshippingaddresslist', function() {
    var obj = {
        ...
        template: '<style>.dropdown-menu { font-size: 11px; }</style>' +
            ...
            '<input type="text" id="shippingAddress" ng-model="currentOrder.ShipAddress" placeholder="{{orderShipAddress ? orderShipAddress.AddressName : \'Search for Shipping Address\' | r}}"' +
